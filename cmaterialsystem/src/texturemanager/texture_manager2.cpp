...
msys::TextureLoadInfo::TextureLoadInfo(util::AssetLoadFlags flags)
	: util::AssetLoadInfo{flags},mipmapMode{TextureMipmapMode::LoadOrGenerate}
{}
	...
	: m_context{context}
{
	...
	auto gliHandler = [](util::IAssetManager &assetManager) -> std::unique_ptr<msys::ITextureFormatHandler> {
		return std::make_unique<msys::TextureFormatHandlerGli>(assetManager);
	};
	...
	RegisterFormatHandler("vtf",[](util::IAssetManager &assetManager) -> std::unique_ptr<msys::ITextureFormatHandler> {
		return std::make_unique<msys::TextureFormatHandlerVtf>(assetManager);
	});
	RegisterFormatHandler("vtex_c",[](util::IAssetManager &assetManager) -> std::unique_ptr<msys::ITextureFormatHandler> {
		return std::make_unique<msys::TextureFormatHandlerVtex>(assetManager);
	});

	auto uimgHandler = [](util::IAssetManager &assetManager) -> std::unique_ptr<msys::ITextureFormatHandler> {
		return std::make_unique<msys::TextureFormatHandlerUimg>(assetManager);
	};
